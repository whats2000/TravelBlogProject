<div class="modal fade" id="add-post-form" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="./post_edit/add_post_form/add_post_form_handle.php" enctype="multipart/form-data"
                method="POST">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-12">
                            ...
                            <div class="input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm">
                                <input type="file" name="upload-post-picture" id="upload-post-picture"
                                    class="form-control border-0" accept=".png, .jpg, .jpeg, .icon, .svg">
