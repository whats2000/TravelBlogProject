<div class="modal fade" id="add-article-form" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="./post_edit/article_add/add_article_form_handle.php" enctype="multipart/form-data"
                method="POST">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-12">
                            ...
                            <div class="input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm">
                                <input type="file" onchange="readURL(this);" name="upload-article-picture"
                                    id="upload-article-picture" class="form-control border-0"
                                    accept=".png, .jpg, .jpeg, .icon, .svg">
                                <label id="upload-label" for="upload-article-picture"
                            ...
                            <div class="mt-5 mb-3">
                                ...
                                <div class="form-check my-2 d-flex align-items-center">
                                    <input class="form-check-input mt-0" type="radio" name="article-display"
                                        value="normal" id="article-display1" checked>
                                    <label class="form-check-label ps-2" for="inlineRadio1">Normal</label>
                                </div>
                                <div class="form-check my-2 d-flex align-items-center">
                                    <input class="form-check-input mt-0" type="radio" name="article-display"
                                        value="card" id="article-display2">
