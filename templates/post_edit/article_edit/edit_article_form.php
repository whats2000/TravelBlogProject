...
<div class="modal fade edit-article-form" id="edit-article-<?=$value["id"]?>" data-bs-backdrop="static"
    data-bs-keyboard="false" tabindex="-1" aria-labelledby="name-form-label" aria-hidden="true">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-12">
                            ...
                            <div class="input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm">
                                <input type="file" onchange="readEditURL(this);" name="upload-article-picture-edit"
                                    id="upload-article-picture-edit-<?=$value["id"]?>"
                                    class="form-control border-0 upload-article-picture-edit"
                                    accept=".png, .jpg, .jpeg, .icon, .svg">
                                <label id="upload-label" for="upload-article-picture-edit-<?=$value["id"]?>"
                                    class="font-weight-light text-muted">
                                    Select a image
                                </label>
                                <label for="upload-article-picture-edit-<?=$value["id"]?>"
                            ...
                            <div class="mt-5 mb-3">
                                ...
                                <div class="form-check my-2 d-flex align-items-center">
                                    <input class="form-check-input mt-0" type="radio" name="article-display-edit"
